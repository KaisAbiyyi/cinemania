...
const TopBilledCast: FC<TopBilledCastProps> = ({ detailType, id }) => {
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-8 overflow-x-scroll scrollbar-thin scrollbar-thumb-primary scrollbar-track-rounded-full scrollbar-thumb-rounded-full scrollbar-corner-rounded scrollbar-w-3 scrollbar-track-transparent">
