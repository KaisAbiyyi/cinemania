...
const DetailHeroSegment: FC<DetailHeroSegmentProps> = ({ detail, detailType }) => {
    ...
    return (
        <div className="relative flex flex-col">
            <img src={`${imagePath}/original/${detail.backdrop_path}`} className="relative inset-0 z-0 object-cover w-full h-full lg:opacity-20" />
            <div className="flex gap-8 lg:items-center relative  lg:absolute lg:bg-gradient-to-b lg:from-primary lg:via-primary/80 lg:to-transparent w-full lg:h-full inset-0 p-4 lg:p-16 !z-20">
                <img src={`${imagePath}/w500/${detail.poster_path}`} className="hidden w-64 border rounded-lg opacity-75 lg:block border-primary-foreground/40 border-opacity-5 xl:w-96 drop-shadow-2xl" />
