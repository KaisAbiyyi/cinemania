...
const TVAiringToday: FC = () => {
    ...
    const {
        ...
        queryKey: ['getTVAiringToday', sortBy, FromReleaseDate, ToReleaseDate, userScore, minimumUserVotes, selectedGenres, runtime],
    ...
    return (
        <>
            <Helmet>
                <title>TV Shows Airing Today | Cinemania</title>
            </Helmet>
            <div className="flex flex-col gap-8 px-8 pb-8">
                <CardTitle>TV Shows Airing Today</CardTitle>
                <div className="flex flex-col gap-4">
                    <div className="flex flex-wrap gap-2">
                        <Link to="/tv/airing-today" className={buttonVariants({ variant: "default", className: "!justify-between" })}>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5">
                    {(TrendingPending || TVGenrePending) ? <TVAiringTodaySkeleton /> :
                    ...
                    {isFetchingNextPage && <TVAiringTodaySkeleton />}
                </div>
