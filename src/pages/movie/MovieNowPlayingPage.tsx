...
const MovieNowPlaying: FC = () => {
    ...
    const [FromReleaseDate, setFromReleaseDate] = useState<Date>(new Date(new Date().setMonth(new Date().getMonth() - 1)));
    ...
    const {
        ...
        queryKey: ['getNowPlayingMovies', sortBy, FromReleaseDate, ToReleaseDate, selectedGenres, userScore, minimumUserVotes, runtime],
    ...
    return (
        <>
            <Helmet>
                <title>Now Playing Movies | Cinemania</title>
            </Helmet>
            <div className="flex flex-col gap-8 px-8 pb-8">
                <CardTitle>Now Playing Movies</CardTitle>
                <div className="flex flex-col gap-4">
                    <div className="flex flex-wrap gap-2">
                        <Link to="/movie/now-playing" className={buttonVariants({ variant: "default", className: "!justify-between" })}>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5">
                    {(TrendingPending || MovieGenrePending) ? <MovieNowPlayingSkeleton /> :
                    ...
                    {isFetchingNextPage && <MovieNowPlayingSkeleton />}
                </div>
